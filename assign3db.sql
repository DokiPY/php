...
CREATE TABLE ta(tauserid VARCHAR(8) NOT NULL, firstname VARCHAR(30) NOT NULL, lastname VARCHAR(30) NOT NULL, studentnum CHAR(9) NOT NULL, degreetype VARCHAR(7), image VARCHAR(200), PRIMARY KEY(tauserid));
...
SELECT * FROM ta;
INSERT INTO ta VALUES ('mgeller','Monica','Geller','251000123','PhD','https://i.pinimg.com/originals/bf/85/8d/bf858d262ce992754e2b78042c9e0fe8.gif');
INSERT INTO ta VALUES ('rgeller','Ross','Geller','251000222','Masters',"null");
INSERT INTO ta VALUES ('rgreen','Rachel','Green','251000333','PhD',"null");
INSERT INTO ta VALUES ('cgeller','Chandler','Geller','251000444','PhD',"null");
INSERT INTO ta VALUES ('jbing','Joey','Bing','251000444','PhD',"null");
INSERT INTO ta VALUES ('pbing','Phoebe','Bing','251000555','Masters',"null");
INSERT INTO ta VALUES ('pbing2','Patty','Bing','251000666','Masters',"null");
SELECT * FROM ta;
